...
export const EvolutionPage: React.FC = () => {
  ...
  useEffect(() => {
    if (sectors.length > 0 && !formData.recordingSectorId) {
      const defaultSectorId =
        currentUser?.role === "COORDENADOR" && currentUser.sectorId
  ...
  const loadActiveServices = async (pid: string) => {
    try {
      ...
      setActiveServices(
        q?.filter((i) => i.status !== "FINISHED" && i.status !== "CANCELLED") ||
          [],
      );
    } catch (err) {
  ...
  const handleStartAttendance = async (queueId: string) => {
    ...
    try {
      await dataService.updateQueueStatus(
        queueId,
        "IN_PROGRESS",
        currentUser.id,
      );
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      doc.text("PRONTUÁRIO DE ATENDIMENTO ESPIRITUAL", 105, 26, {
        align: "center",
      });
    ...
    try {
      if (editingEvo) {
        ...
        await dataService.createLog(
          ...
          `ADM ${currentUser?.name || "Admin"} editou o registro de atendimento do participante ${selectedP.id}`,
        );
        setEditingEvo(null);
      } else {
    ...
    return (
      <div className="h-screen w-full flex flex-col items-center justify-center gap-4 text-center p-8 bg-white">
        ...
        <p className="text-gray-500 max-w-md">
          Ocorreu um problema ao carregar os dados. Você pode tentar resetar o
          sistema nas configurações se o problema persistir.
        </p>
        <button
  ...
  return (
    <div className="p-4 sm:p-8 min-h-screen lg:h-full flex flex-col gap-4 sm:gap-8">
      ...
      <div className="lg:flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 min-h-0">
                      ...
                      <div
                        className={cn(
                          ...
                          isSelected
                            ...
                            : "bg-indigo-50 border-indigo-50 text-indigo-600",
                        )}
                      >
                        {(p.name || "?").charAt(0)}
                      </div>
                        ...
                        {isActive && (
                          ...
                          >
                            ...
                            <span className="truncate">
                              Espera:{" "}
                              {
                                sectors.find((s) => s.id === isActive.sectorId)
                                  ?.name
                              }
                            </span>
                          </div>
        ...
        <div
          ref={detailsRef}
          className="lg:col-span-8 lg:overflow-y-auto no-scrollbar pb-10 min-h-0 w-full"
        >
          {selectedP ? (
            <div
              key={selectedP.id}
                    ...
                    <div className="flex-1 min-w-0 text-center sm:text-left space-y-6">
                      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                        <div className="min-w-0 space-y-1">
                          <h2 className="text-3xl sm:text-4xl font-black text-indigo-950 tracking-tight leading-tight truncate">
                            {selectedP?.name}
                          </h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 pt-8 border-t border-indigo-50">
                    <div className="flex items-center gap-3 p-4 bg-gray-50/50 rounded-[24px] border border-transparent hover:border-indigo-100 hover:bg-white hover:shadow-lg hover:shadow-indigo-500/5 transition-all duration-300 group/item">
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="text-[8px] font-black uppercase text-gray-400 tracking-wider mb-0.5">
                          Contato
                        </p>
                    ...
                    <div className="flex items-center gap-3 p-4 bg-gray-50/50 rounded-[24px] border border-transparent hover:border-indigo-100 hover:bg-white hover:shadow-lg hover:shadow-indigo-500/5 transition-all duration-300 group/item">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p
                          ...
                          title={selectedP?.address}
                        >
                          {selectedP?.address || "Não Informado"}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="xl:col-span-7 space-y-6">
                      ...
                      <div className="relative pl-8">
                        ...
                        <div className="bg-gradient-to-br from-emerald-50/50 to-white p-6 rounded-[32px] border border-emerald-100 shadow-sm transition-all hover:shadow-md">
                          ...
                          <div className="space-y-2">
                            <p className="text-[10px] font-black uppercase text-emerald-400/80 tracking-widest pl-1">
                    ...
                    {history.length > 0 ? (
                      ...
                      <div className="bg-gray-50/50 rounded-[48px] p-16 text-center border-2 border-dashed border-gray-100">
                        <History
                          size={48}
                          className="mx-auto text-gray-200 mb-4 opacity-50"
                        />
                        <h4 className="text-gray-400 font-bold text-lg mb-1">
                  ...
                  <div className="xl:col-span-5 space-y-6">
                    <div className="lg:sticky lg:top-8">
                      <h3 className="text-sm font-black text-gray-400 uppercase tracking-widest flex items-center gap-2 mb-4 px-2">
                        <Send size={18} className="text-indigo-400" /> Registro
                        de Atendimento
                      </h3>
                          ...
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <button
                              ...
                              onClick={() => {
                                setEditingEvo(null);
                                setFormData({
                                  recordingSectorId: sectors[0].id,
                                  notes: "",
                                  recommendations: "",
                                  referralSectors: [],
                                  encaminhamento: "",
                        ...
                        <div className="space-y-2">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                recordingSectorId: e.target.value,
                              })
                            }
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            ...
                            <button
                              ...
                              disabled={
                                isImprovingRecs || !formData.recommendations
                              }
                              className={cn(
                        ...
                        <div className="space-y-4 pt-4 border-t border-indigo-50">
                            ...
                            {formData.attachments.length > 0 ? (
                              <div className="grid grid-cols-1 gap-2">
                                {formData.attachments.map((file, fidx) => (
                                  <div
                                    key={fidx}
                                    className="flex items-center justify-between p-3 bg-indigo-50/50 rounded-2xl border border-indigo-100"
                                  >
                          ...
                          <div className="grid grid-cols-1 gap-3">
                            <div className="relative">
                              ...
                              >
                                <option value="">
                                  Sem conclusão específica
                                </option>
                                <option value="Doutrinária">
                                  Assistência Espiritual / Doutrinária
                                </option>
                                <option value="Tratamento">
                                  Tratamento de Desobsessão
                                </option>
                                <option value="Cursos">
                                  Cursos / Escola de Aprendizes
                                </option>
                                <option value="Evangelização">
                                  Evangelização Infantil/Juvenil
                                </option>
                              </select>
                            </div>
                          </div>
                                ...
                                .map((sector) => (
                                  <button
                                    ...
                                    className={cn(
                                      ...
                                      formData.referralSectors.includes(
                                        sector.id,
                                      )
                  ...
                  <div className="bg-white rounded-[48px] border-2 border-indigo-50 shadow-2xl shadow-indigo-100 overflow-hidden">
                    <div className="p-8 sm:p-12 space-y-10">
                      ...
                      <div className="flex items-center gap-6">
                        ...
                        <div>
                          <h2 className="text-3xl font-black text-indigo-950 tracking-tight italic">
                            Formulário de Atendimento Fraterno
                          </h2>
                          <p className="text-gray-500 font-medium">
                            Ficha de acolhimento e primeira escuta doutrinária
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="space-y-4">
                            <p className="text-sm font-bold text-gray-600 leading-tight">
                              Relate brevemente a necessidade (dificuldades
                              existenciais, conflitos, saúde, etc.):
                            </p>
                            <textarea
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 gap-3">
                              {[
                                "Primeira vez na casa / Sem conhecimento",
                                "Já frequentou outras casas",
                                "Conhece mas não frequenta",
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="pt-6">
                            ...
                            <p className="text-[10px] text-gray-400 font-bold uppercase text-center mt-4 tracking-widest">
                              Ao salvar, este formulário será registrado no
            ...
            <div className="h-full flex flex-col items-center justify-center text-center space-y-6 py-20 bg-gray-50/50 rounded-[40px] border-2 border-dashed border-gray-100">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-400">
                  Nenhum Atendido Selecionado
                </h3>
                <p className="text-gray-400 max-w-xs mx-auto mt-2">
                  Selecione um irmão na lista à esquerda para ver seu histórico
                  ou realizar um novo encaminhamento.
                </p>
              </div>
            </div>
          )}
